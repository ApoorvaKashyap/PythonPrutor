...
def readItems():
    ...
    #change ./Lab 5/__VendingItems__.csv to __VendingItems__.csv for use on Prutor.
    vendingItems = open('./Lab 5/__VendingItems__.csv', 'r')
